...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import liblsl_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("b37880e1-55fa-5503-9f1a-f1223ce0b53e"))
platforms = [Pkg.Artifacts.unpack_platform(e, "liblsl", artifacts_toml) for e in artifacts["liblsl"]]
...
if best_platform === nothing
    @debug("Unable to load liblsl; unsupported platform $(triplet(platform_key_abi()))")
else
